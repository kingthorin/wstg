...
- Red Hat Enterprise Linux version 8 for x86-64 architecutre:
...
The Common Platform Enumperation scheme (CPE) is a structured naming scheme for information technology systems, software, and packages maintained by `NVD`. Commonly used in conjunction with the Common Vulnerabilities and Exposures identification codes (e.g. `CVE‑2017‑0147`). Despite being considered a deprecated scheme in benefit of `SWID`, `CPE` is still widely used by several security solutions.
...
Package URL standardizes how software package metadata is represented so that packages can universally be located regardless of what vendor, project, or ecosystem the packages belongs.

A purl is a valid `RFC3986` ASCII string defnid URL composed seven elements. Each of them is separated by a defined character in order to make it easily manipulated by software.

`scheme:type/namespace/name@version?qualifiers#subpath`

The defintion for each components is:

- _scheme_: URL scheme compilant constant value of "pkg". (**Required**).
...
- Curl software, packaged as a .deb Debian Jessie package for an i386 architecture: `pkg:deb/debian/curl@7.50.3-1?arch=i386&distro=jessie`
...
- _Golang_: <https://github.com/package-url/packageurl-go>
- _.NET_: <https://github.com/package-url/packageurl-dotnet>
- _JVM_: <https://github.com/package-url/packageurl-java>, <https://github.com/sonatype/package-url-java>
- _Python_: <https://github.com/package-url/packageurl-python>
- _Rust_: <https://github.com/package-url/packageurl-rs>
- _JS_: <https://github.com/package-url/packageurl-js>

## Recommendation usages
...
_Note:_ Due to the deprecated status of `CPE`, it's recomended that the new projects implement `SWID` when they need to decide between both methods. Even though, `CPE` is known to be a widely used naming schema on currently active projects.
